    ...
    <>
      ...
      <section className="bg-sm-50 border-y border-gray-100">
        <div className="container-page py-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-xs uppercase tracking-widest text-sm-400 font-semibold">Empresas que confían en nosotros</p>
      ...
      {blog.length > 0 && (
        <section className="container-page py-14">
          <div className="flex items-center justify-between mb-6">
            <div>
              <span className="badge-blue"><Tag className="w-3 h-3 inline mr-1" /> Blog</span>
